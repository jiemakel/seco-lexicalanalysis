...
public class CombinedLexicalAnalysisService extends HFSTLexicalAnalysisService {
	...
	public String baseform(String string, Locale lang, boolean baseformSegments, boolean guessUnknown, int depth) {
		try {
			List<WordToResults> crc = analyze(string, lang, Collections.EMPTY_LIST, baseformSegments, guessUnknown, false, depth);
	...
	public List<WordToResults> analyze(String str, Locale lang, List<String> inflections, boolean segments, boolean guessUnknown, boolean segmentUnknown) {
		return analyze(str, lang, inflections, segments, guessUnknown, segmentUnknown, 2);
	}
	...
	public String inflect(String string, List<String> inflections, boolean segments, boolean baseform, boolean guessUnknown, Locale lang) {
		StringBuilder ret = new StringBuilder();
		for (WordToResults part : analyze(string, lang, inflections, false, guessUnknown, false, 0)) {
	...
	public static void main(String[] args) {
		...
		System.out.println(las.analyze("baa", new Locale("fi"),Collections.EMPTY_LIST,false,true,true,2));
		System.out.println(las.analyze("twiittasi", new Locale("fi"),Collections.EMPTY_LIST,false,true,true,2));
		...
		System.out.println(las.analyze("hän twiittasi", new Locale("fi"),Collections.EMPTY_LIST,false,true,true,2));
		System.out.println(las.analyze("kiipesin puuhun", new Locale("fi"),Collections.EMPTY_LIST,false,true,true,2));
		System.out.println(las.baseform("ulkoasiainministeriövaa'at soitti fagottia", new Locale("fi"),true, true));
		System.out.println(las.analyze("ulkoasiainministeriövaa'at 635. 635 sanomalehteä luin Suomessa", new Locale("fi"), Arrays.asList(new String[] { "V N Nom Sg", "A Pos Nom Pl", "Num Nom Pl", " N Prop Nom Sg", "N Nom Pl" }), true, true, true));
